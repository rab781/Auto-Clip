...
def get_thread_local_tracker():
    """
    Get or create a thread-local instance of FaceTracker.
    Avoids severe CPU overhead from redundant model loading per task while maintaining thread safety.
    """
