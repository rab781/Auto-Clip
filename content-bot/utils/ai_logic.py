...
def _parse_clips_json(content: str) -> list:
    ...
    # ⚡ Bolt Optimization: Use native string search over greedy regex
    # Impact: Avoids O(N^2) catastrophic backtracking in regex when parsing large LLM responses.
    # Native C-based string methods (.find and .rfind) are significantly faster for block extraction.
