...
def _parse_clips_json(content: str) -> list:
    ...
    # Impact: Replaces greedy regex (O(N^2)) with native C-backed string find (O(N)), preventing
    # catastrophic backtracking on large LLM outputs and drastically speeding up JSON parsing.
