...
def _parse_clips_json(content: str) -> list:
    ...
    # Impact: Replaces O(N^2) catastrophic backtracking in regex with O(N) C-level string operations.
    # Measurement: Eliminates parsing hangs on large LLM responses (>10KB).
