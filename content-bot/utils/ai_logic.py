...
def _parse_clips_json(content: str) -> list:
    ...
    # Impact: Replaces O(N²) regex backtracking with O(N) C-optimized string search
    # Measurement: Compare execution time of _parse_clips_json on a 1MB LLM response payload
