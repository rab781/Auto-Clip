...
def _parse_clips_json(content: str) -> list:
    ...
    # Impact: Replaces O(N²) regex backtracking on large text outputs with O(N) C-level string search.
    # Measurement: Extracting JSON from a 5MB LLM context block is virtually instantaneous.
